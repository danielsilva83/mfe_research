...
def list_available_datasets1(filter: Optional[str] = None, search: Optional[str] = None, area: Optional[str] = None) -> List[str]:
    '''
    Returns a list of IDs of datasets that can be imported via fetch_ucirepo function
    ...
    Returns:
        List[str]: List of IDs of available datasets
    '''
